...
<div style={{ display: "flex", gap: "24px", alignItems: "center" }}>
  <SmartLink suffixIcon="code" href="https://github.com/RayChen666/XR-Swarm-Drone-Control">
    <Text variant="body-default-m">Project code</Text>
  </SmartLink>
  <SmartLink suffixIcon="arrowUpRightFromSquare" href="https://arxiv.org/abs/2605.21680">
    <Text variant="body-default-m">Paper Link</Text>
  </SmartLink>
</div>
