...
paperLink: "https://arxiv.org/abs/2605.21680"
---
...
<iframe
  width="100%"
  style={{ borderRadius: '20px', marginBottom: '2rem', aspectRatio: '16/9', border: 'none' }}
  src="https://www.youtube.com/embed/o2iKKrLNM7g"
  allowFullScreen
/>

<div style={{ display: "flex", gap: "24px", alignItems: "center" }}>
  <SmartLink suffixIcon="github" href="https://github.com/RayChen666/XR-Swarm-Drone-Control">
    <Text variant="body-default-m">Project code</Text>
  </SmartLink>
  <SmartLink suffixIcon="arxiv" href="https://arxiv.org/abs/2605.21680">
    <Text variant="body-default-m">Full paper link</Text>
  </SmartLink>
</div>
